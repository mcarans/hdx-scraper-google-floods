# Collector for Google Floods Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-google-floods/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-google-floods/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-google-floods/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-google-floods?branch=main)
 ...
 **hdx-scraper-google-floods** as specified in the parameter
 *user_agent_lookup*.
...
```shell
    pip install .
    python -m hdx.scraper.google.floods
```
